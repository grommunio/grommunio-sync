...
class ZPushAdminCLI {
    ...
    static public function UsageInstructions() {
        return  "Usage:\n\tgrammm-sync-admin.php -a ACTION [options]\n\n" .
                "Parameters:\n\t-a list/lastsync/listdetails/wipe/remove/resync/clearloop/fixstates/addshared/removeshared/listshares\n\t[-u] username\n\t[-d] deviceid\n" .
                "\t[-t] type\tthe following types are available: '".self::TYPE_OPTION_EMAIL."', '".self::TYPE_OPTION_CALENDAR."', '".self::TYPE_OPTION_CONTACT."', '".self::TYPE_OPTION_TASK."', '".self::TYPE_OPTION_NOTE."', '".self::TYPE_OPTION_HIERARCHY." or a folder id.\n" .
        ...
        switch ($action) {
            ...
            case "fixstates-upgrade":
                ...
                if (!defined('IGNORE_FIXSTATES_ON_UPGRADE') || IGNORE_FIXSTATES_ON_UPGRADE == false) {
                    ...
                    echo "\nGrammm-Sync: Not executing 'fixstates' as IGNORE_FIXSTATES_ON_UPGRADE is set. You should execute 'grammm-sync-admin -a fixstates' manually!\n\n";
                    exit(0);
                }
                break;
    ...
    static private function printDeviceData($deviceId, $user) {
        ...
        elseif (!self::$shared) {
            ...
            print("There are some messages which need attention because they could not be synchronized. Run grammm-sync-admin without -s or --shared.\n");
        }
