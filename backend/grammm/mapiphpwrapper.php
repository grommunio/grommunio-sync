 ...
 * want all MAPI code to be separate from the rest of grammm-sync. To do so all
...
class PHPWrapper {
    ...
    public function ImportMessageChange($props, $flags, $retmapimessage) {
        ...
        // substitute the MAPI SYNC_NEW_MESSAGE flag by a grammm-sync proprietary flag
